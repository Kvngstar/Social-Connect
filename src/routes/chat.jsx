...
export default function Chat() {
  ...
  useEffect(() => {
    ...
    socket.on("newMessage", (message) => {
      ...
      const elementArray = document.querySelectorAll(".container .right .chat");
                ...
                return (
                  ...
                  >
                    <img
                      ...
                      alt=""
                    />
                    <span class="name">{data.groupName}</span>
                    <span class="time">2:09 PM</span>
                    <span class="preview">{data.groupDescription}</span>
                  </li>
                );
              })}
          </ul>
              ...
              return (
                ...
                >
                  ...
                  {v.groupMessages.length > 0 ? (
                      ...
                      return (
                        <div>
                          ...
                          <div
                            class={
                              "bubble " +
                              (u._userId == jwtDecode(token)._id ? "me" : "you")
                            }
                          >
                    ...
                    <div>No messages yet, Be the first to send</div>
                  )}
                </div>
              );
            })}
