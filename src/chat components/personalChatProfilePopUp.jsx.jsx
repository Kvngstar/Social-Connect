            ...
            {personalChatControl.showPersonalChatProfile && (
                <div className="profile-popup rounded d-flex">
                    <div className="group-menu bg-secondary d-flex flex-column p-1">
                        <div className="nav-item-profile rounded active-item"  onClick={(event)=>{ShowOverview();ToggleProfileNav(event)}}>
                            Overview{' '}
                        </div>
                        <div onClick={(event)=>{ShowMedia();ToggleProfileNav(event)}} className='nav-item-profile rounded'>Media</div>
                        <div onClick={(event)=>{Showlinks();ToggleProfileNav(event)}} className='nav-item-profile rounded'>Links</div>
                    </div>
...
{personalChatControl.media && <div className='d-flex align-items-center justify-content-center h-100 w-100'> 
