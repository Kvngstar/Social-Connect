                ...
                groupChatDisplay.showGroupChat && (
                    <div className="profile-popup rounded d-flex">
                        ...
                        <div className="view-group-menu bg-light">
                          ...
                          { groupControl.members &&  <div className=" pt-3 px-3 pb-3">
                                <div className="bg-dark p-1">
                                    <div className="fw-bold px-3 mb-2">
                                        {groupChatDisplay.members.length}
                                    </div>
                                    <div className="px-3">
                                        <input
                                            type="text"
                                    ...
                                    {groupChatDisplay.members.length > 0 && 
                                        groupChatDisplay.members.map((v) => {
                                            return (
