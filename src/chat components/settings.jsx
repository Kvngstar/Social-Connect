              ...
              {settingsControls.general && (
                <div className="pt-3 px-3 pb-3">
                  ...
                  <div className="mt-3 mb-2">
                    ...
                    <select name="language" className="form-select" id="">
              ...
              {settingsControls.help && (
                <div className="pt-3 px-3 pb-3">
                  ...
                  <div className="d-flex flex-column">
                    ...
                    <div>
                      <small>
                        We will like to know your thoughts about this app
                      </small>
                      <div>
                        <a href="#">
                  ...
                  <div className=" mt-2">
                    {showInputFor.about === false ? (
                      <div className="d-flex justify-content-between">
                        ...
                        <div className="" onClick={EditAbout}>
                          edit
                        </div>
                      </div>
                    ) : (
                  ...
                  <div className="mt-2">
                    {showInputFor.phoneNo === false ? (
                      <div className="d-flex justify-content-between">
                        ...
                        <div className="" onClick={EditPhoneNo}>
                          edit
                        </div>
                      </div>
                    ) : (
