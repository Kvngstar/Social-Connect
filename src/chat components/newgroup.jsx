...
export default function NewChat({CreateNewGroup}) {
    return (
        <div className="new-group d-block p-1">
            <div className="fw-bold px-3">NEW CHAT</div>
            <div className="px-3">
                <input type="text" className="input" />
            </div>
            <div className="d-flex mt-2 bg-light  rounded py-2"  onClick={CreateNewGroup}>
